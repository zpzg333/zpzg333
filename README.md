...
- DNS Server (https://github.com/zpzg333/my-k8s-dns)
- MetalLB: K8S Service IP (https://github.com/zpzg333/K8S-MetalLB)
- ContainerLAB: 컨테이너 형 가상화 랩 (https://github.com/zpzg333/C9S-containerLAB)
- network automation service: 실행형 ansible & Pyhton 컨테이너 (ansible & python) (https://github.com/zpzg333/Ansible)
- argocd : k8s 관리 (https://github.com/zpzg333/my-argocd)
